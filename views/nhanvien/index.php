...
<section class="mt-4">
  <div class="container">
    <div class="mb-3 row">
      ...
      <div class="col-md-6">
        <form
          ...
          method="GET"
          class="form-inline float-right js-nhanvien-search"
        >
          <select name="type" class="form-control mr-2">
            <option value="idnv">Mã nhân viên</option>
            <option value="hoten">Họ tên</option>
            <option value="diachi">Địa chỉ</option>
            <option value="mota">Phòng ban</option>
          </select>
    ...
    <table border="1" align="center" class="table table-striped table-bordered table-hover js-nhanvien-table">
      <thead>
        <tr>
          <th>Mã nhân viên</th>
          <th>Họ tên</th>
            ...
            <td align="center">
              <?php if($this->data['user_logged'] === true) { ?>
                ...
                <a href="<?php echo vendor_url_util::makeURL([
                  ...
                  'action' => 'destroy',
                  'params' => ['idnv' => $item['idnv']]
                ]) ?>" class="text-right ml-3 js-destroy" title="Xóa">
